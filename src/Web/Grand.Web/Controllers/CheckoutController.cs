        ...
        public virtual async Task<IActionResult> ConfirmOrder()
        {
            try
            {
                ...
                if (placeOrderResult.Success)
                {
                    ...
                    //CSD
                    var paymentTransaction = await _paymentTransactionService.GetById(placeOrderResult.PaymentTransaction.Id);
                    //if (paymentTransaction == null)
                      //  return RedirectToRoute("HomePage");
                    ...
                    //CSD New field orderNo introduced
                    //success
                    return Json(new { success = 1,orderNo = order.OrderNumber});
                }
