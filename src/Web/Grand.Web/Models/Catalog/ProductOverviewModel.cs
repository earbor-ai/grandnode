...
namespace Grand.Web.Models.Catalog
{
    public partial class ProductOverviewModel : BaseEntityModel
    {
        public ProductOverviewModel()
        {
            ...
            VendorModel = new VendorBriefInfoModel(); //CSD
            BrandModel = new BrandBriefInfoModel(); //CSD
            ProductTags = new List<ProductTagModel>(); //CSD            
        }
        ...
        public bool IsSale { get; set; }  //CSD

        public string VendorId { get; set; }  //CSD

        public string BrandId { get; set; }  //CSD

        public string ProductTagId { get; set; }  //CSD

        public VendorBriefInfoModel VendorModel { get; set; } //CSD

        public BrandBriefInfoModel BrandModel { get; set; } //CSD

        public IList<ProductTagModel> ProductTags { get; set; } //CSD

        public IList<PictureModel> PictureModels { get; set; } //CSD        
