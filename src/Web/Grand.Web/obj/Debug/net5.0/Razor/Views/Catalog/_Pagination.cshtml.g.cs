#pragma checksum "C:\Users\kishore\source\repos\grandnode\grandnode2\src\Web\Grand.Web\Views\Catalog\_Pagination.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "183a4f2ffbe8aaf2e46ce0e9dcafcb2370b4b895"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"183a4f2ffbe8aaf2e46ce0e9dcafcb2370b4b895", @"/Views/Catalog/_Pagination.cshtml")]
    ...
    public class Views_Catalog__Pagination : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
    ...
    <template v-if=""catalog.Model.PagingFilteringContext.TotalPages > 1"">
        <ul class=""pagination"">
            <template v-if=""(catalog.Model.PagingFilteringContext.PageIndex >= 3) && (catalog.Model.PagingFilteringContext.TotalPages > 5)"">
                <li class=""page-item"">
                    <a class=""page-link"" ");
            WriteLiteral("@click=\"catalog.goToPage(1)\">\r\n                        ");
#nullable restore
#line 7 "C:\Users\kishore\source\repos\grandnode\grandnode2\src\Web\Grand.Web\Views\Catalog\_Pagination.cshtml"
                   Write(Loc["pager.firstpagetitle"]);

#line default
#line hidden
#nullable disable
            WriteLiteral("\r\n                    </a>\r\n                </li>\r\n            </template>\r\n            <template v-if=\"catalog.Model.PagingFilteringContext.HasPreviousPage\">\r\n                <li class=\"page-item\">\r\n                    <a class=\"page-link\" ");
            WriteLiteral("@click=\"catalog.goToPage(catalog.Model.PagingFilteringContext.PageNumber - 1)\">");
#nullable restore
#line 13 "C:\Users\kishore\source\repos\grandnode\grandnode2\src\Web\Grand.Web\Views\Catalog\_Pagination.cshtml"
                                                                                                                    Write(Loc["pager.previouspagetitle"]);
...
#nullable disable
            ...
            <template v-for=""item in catalog.pager"">
                <li class=""page-item"" v-bind:class=""{ currentpage: (catalog.Model.PagingFilteringContext.PageNumber) == item }"">
                    <a class=""page-link"" ");
            WriteLiteral(@"@click=""catalog.goToPage(item)"">
                        {{item}}
                    </a>
                </li>
            </template>
            ...
            WriteLiteral("@click=\"catalog.goToPage(catalog.Model.PagingFilteringContext.PageNumber + 1)\">");
#nullable restore
#line 25 "C:\Users\kishore\source\repos\grandnode\grandnode2\src\Web\Grand.Web\Views\Catalog\_Pagination.cshtml"
                                                                                                                    Write(Loc["pager.nextpagetitle"]);
...
#nullable disable
            ...
            <template v-if=""((catalog.Model.PagingFilteringContext.PageIndex + 3) < catalog.Model.PagingFilteringContext.TotalPages) && (catalog.Model.PagingFilteringContext.TotalPages > 5)"">
                <li class=""page-item"">
                    <a class=""page-link"" ");
            WriteLiteral("@click=\"catalog.goToPage(catalog.Model.PagingFilteringContext.TotalPages)\">\r\n                        ");
#nullable restore
#line 31 "C:\Users\kishore\source\repos\grandnode\grandnode2\src\Web\Grand.Web\Views\Catalog\_Pagination.cshtml"
                   Write(Loc["pager.lastpagetitle"]);
