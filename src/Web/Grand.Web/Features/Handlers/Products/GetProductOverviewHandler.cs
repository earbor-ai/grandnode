...
namespace Grand.Web.Features.Handlers.Products
{
    public class GetProductOverviewHandler : IRequestHandler<GetProductOverview, IEnumerable<ProductOverviewModel>>
    {
        ...
        private readonly IVendorService _vendorService; //CSD
        private readonly IBrandService _brandService; //CSD
        private readonly ICacheBase _cacheBase; //CSD
        private readonly IProductTagService _productTagService; //CSD        
        ...
        public GetProductOverviewHandler(
            ...
            IVendorService vendorService, //CSD
            IBrandService brandService, //CSD
            ICacheBase cacheBase, //CSD
            IProductTagService productTagService, //CSD            
        ...
        CatalogSettings catalogSettings)
        {
            ...
            _vendorService = vendorService; //CSD
            _brandService = brandService; //CSD
            _productTagService = productTagService; //CSD
            _cacheBase = cacheBase;//CSD            
        }
            ...
            bool displayPrices, bool enableShoppingCart, bool enableWishlist, int pictureSize, bool priceIncludesTax, Dictionary<string, string> res)
        {
            ...
            //CSD
            var cachedPictures = await PrepareProductPictureModel(product, 0,false,model.Name);
        ...
        private ProductOverviewModel PrepareProductOverviewModel(Product product)
        {
            ...
            var model = new ProductOverviewModel {
                ...
                Sku = product.Sku,
                IsSale = product.IsSale, //CSD
                VendorId = product.VendorId, //CSD
                BrandId = product.BrandId, //CSD
